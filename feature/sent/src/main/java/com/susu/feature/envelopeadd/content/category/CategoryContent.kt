...
fun CategoryContentRoute(
    ...
    viewModel.sideEffect.collectWithLifecycle { sideEffect ->
        when (sideEffect) {
            is CategoryEffect.UpdateParentCategory -> {
                updateParentCategory(sideEffect.category)
            }

            CategoryEffect.FocusCustomCategory -> scope.launch {
                awaitFrame()
    ...
    LaunchedEffect(
        ...
        snapshotFlow { uiState.selectedCategory }
            .collect {
                viewModel.updateParentCategory()
            }
    }
...
fun CategoryContent(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.sent_envelope_add_event_title),
        ...
        Column(
            ...
            if (uiState.showTextFieldButton) {
                SusuTextFieldFillMaxButton(
                    ...
                    text = uiState.customCategory.name,
